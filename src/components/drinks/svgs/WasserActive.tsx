      ...
      <g id="ripples-animation" clipPath="url(#waterSurfaceMask)">
        ...
        */}
        ...
        <ellipse cx="75.5" cy="79" rx="0" ry="0" fill="none" stroke="white" strokeWidth="1">
          <animate attributeName="rx" begin="ripples.begin" dur="2s" values="0; 35" repeatCount="indefinite" />
          <animate attributeName="ry" begin="ripples.begin" dur="2s" values="0; 15" repeatCount="indefinite" />
          <animate attributeName="opacity" begin="ripples.begin" dur="2s" values="1; 0" repeatCount="indefinite" />
        </ellipse>
        {/* Ring 2 (startet mit 0.5s Verzögerung) */}
        <ellipse cx="75.5" cy="79" rx="0" ry="0" fill="none" stroke="white" strokeWidth="1">
          <animate attributeName="rx" begin="ripples.begin+0.5s" dur="2s" values="0; 35" repeatCount="indefinite" />
          <animate attributeName="ry" begin="ripples.begin+0.5s" dur="2s" values="0; 15" repeatCount="indefinite" />
          <animate attributeName="opacity" begin="ripples.begin+0.5s" dur="2s" values="1; 0" repeatCount="indefinite" />
        </ellipse>
        {/* Unsichtbarer "Taktgeber" für die Animation */}
        <animate id="ripples" begin="0s" dur="4s" repeatCount="indefinite" />
      </g>
    </svg>
  );
}