  ...
  return (
    ...
    <g clipPath="url(#liquidAreaClip)">
        <circle cx="85" cy="160" r="2" fill="white" stroke="black" strokeWidth="0.5">
            <animate attributeName="cy" from="160" to="75" dur="6.5s" begin="0.2s" repeatCount="indefinite" />
            <animate attributeName="cx" values="85; 86; 84.5; 85" dur="6.5s" begin="0.2s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.1;0.9;1" dur="6.5s" begin="0.2s" repeatCount="indefinite" />
        </circle>
        <circle cx="65" cy="172" r="2.5" fill="white" stroke="black" strokeWidth="0.5">
            <animate attributeName="cy" from="172" to="75" dur="5.2s" begin="1.3s" repeatCount="indefinite" />
            <animate attributeName="cx" values="65; 64; 65.5; 65" dur="5.2s" begin="1.3s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.1;0.85;1" dur="5.2s" begin="1.3s" repeatCount="indefinite" />
        </circle>
        <circle cx="92" cy="155" r="2.5" fill="white" stroke="black" strokeWidth="0.5">
            <animate attributeName="cy" from="155" to="75" dur="7.8s" begin="2.4s" repeatCount="indefinite" />
            <animate attributeName="cx" values="92; 93.5; 91.5; 92" dur="7.8s" begin="2.4s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.15;0.9;1" dur="7.8s" begin="2.4s" repeatCount="indefinite" />
        </circle>
        <circle cx="78" cy="178" r="2" fill="white" stroke="black" strokeWidth="0.5">
            <animate attributeName="cy" from="178" to="75" dur="8.1s" begin="0.8s" repeatCount="indefinite" />
            <animate attributeName="cx" values="78; 77; 78.5; 78" dur="8.1s" begin="0.8s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.1;0.95;1" dur="8.1s" begin="0.8s" repeatCount="indefinite" />
        </circle>
        <circle cx="70" cy="150" r="1.5" fill="white" stroke="black" strokeWidth="0.5">
            <animate attributeName="cy" from="150" to="75" dur="4.5s" begin="3.1s" repeatCount="indefinite" />
            <animate attributeName="cx" values="70; 71.5; 69.5; 70" dur="4.5s" begin="3.1s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.1;0.8;1" dur="4.5s" begin="3.1s" repeatCount="indefinite" />
        </circle>
        <circle cx="90" cy="168" r="2" fill="white" stroke="black" strokeWidth="0.5">
            <animate attributeName="cy" from="168" to="75" dur="6.2s" begin="2.5s" repeatCount="indefinite" />
            <animate attributeName="cx" values="90; 89; 90.5; 90" dur="6.2s" begin="2.5s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.1;0.9;1" dur="6.2s" begin="2.5s" repeatCount="indefinite" />
        </circle>
        <circle cx="75" cy="157" r="2.5" fill="white" stroke="black" strokeWidth="0.5">
            <animate attributeName="cy" from="157" to="75" dur="5.8s" begin="1.9s" repeatCount="indefinite" />
            <animate attributeName="cx" values="75; 74; 75.5; 75" dur="5.8s" begin="1.9s" repeatCount="indefinite" />
            <animate attributeName="opacity" values="0;1;1;0" keyTimes="0;0.12;0.88;1" dur="5.8s" begin="1.9s" repeatCount="indefinite" />
        </circle>
    </g>
